...
const M: Record<string, any> = {
  ru: {
    ...
    hereTitle: "Был здесь",
    guessAsk: (p: string) => `📍 Похоже, это ${p}. Поставить точку туда?`, guessYes: "📍 Да, поставить", guessNo: "Выберу сам",
    noGeoVideo: "📍 Координат в ролике нет — Telegram стирает их при сжатии. Поставь точку сама/сам: открой карту, выбери ролик внизу и ткни в место. Или пришли видео файлом — тогда место съёмки доедет.",
  ...
  en: {
    ...
    hereTitle: "Was here",
    guessAsk: (p: string) => `📍 Looks like ${p}. Put the point there?`, guessYes: "📍 Yes, put it", guessNo: "I'll pick myself",
    noGeoVideo: "📍 The clip carries no coordinates — Telegram strips them when compressing. Place it by hand: open the map, pick the clip below and tap the spot. Or send the video as a file — then the location survives.",
  ...
  uk: {
    ...
    hereTitle: "Був тут",
    guessAsk: (p: string) => `📍 Схоже, це ${p}. Поставити точку туди?`, guessYes: "📍 Так, постав", guessNo: "Оберу сам",
    noGeoVideo: "📍 Координат у ролику немає — Telegram стирає їх при стисненні. Постав точку сам: відкрий карту, обери ролик унизу й тицьни в місце. Або надішли відео файлом.",
  ...
  fr: {
    ...
    guessAsk: (p: string) => `📍 On dirait ${p}. Placer le point là ?`, guessYes: "📍 Oui, place-le", guessNo: "Je choisis",
    noGeoVideo: "📍 Le clip ne porte pas de coordonnées — Telegram les efface en compressant. Place-le à la main : ouvre la carte, choisis le clip en bas et touche l'endroit. Ou envoie la vidéo en fichier.",
  ...
  es: {
    ...
    guessAsk: (p: string) => `📍 Parece ${p}. ¿Pongo el punto ahí?`, guessYes: "📍 Sí, ponlo", guessNo: "Lo elijo yo",
    noGeoVideo: "📍 El clip no trae coordenadas — Telegram las borra al comprimir. Colócalo a mano: abre el mapa, elige el clip abajo y toca el lugar. O manda el vídeo como archivo.",
