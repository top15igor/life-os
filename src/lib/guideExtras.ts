...
const E: Record<Locale, Extras> = {
  ru: {
    ...
    changelog: [
      ...
      { t: "Красивая ссылка с твоим именем", d: "Раньше ссылка-приглашение была набором случайных букв (/i/ab3k9z). Теперь у тебя есть имя-ссылка, как @имя в Instagram: /i/igor. Оно создаётся автоматически из твоего имени, и им же работает твоя публичная страница /p/igor — одно имя на всё. Поменять на своё можно в Профиле → «Твоё имя-ссылка»: при вводе сразу видно, свободно оно или занято. Старые ссылки, которые ты уже кому-то отправлял, продолжают работать.", tag: "improved" },
  ...
  en: {
    ...
    changelog: [
      { t: "A pretty link with your name", d: "Your invite link used to be a random string (/i/ab3k9z). Now you have a link name, like @name on Instagram: /i/igor. It's created automatically from your name and also powers your public page /p/igor — one name for everything. Change it in Profile → “Your link name”: as you type, you instantly see whether it's free or taken. Any old links you already shared keep working.", tag: "improved" },
