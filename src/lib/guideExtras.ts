...
const E: Record<Locale, Extras> = {
  ru: {
    ...
    changelog: [
      { t: "Главный экран стал легче", d: "Убрали лишнее с «Сегодня», чтобы не перегружать: пропала строка со стриком и кнопкой «Открыть дашборд» и карточка «Фокус дня». Осталось главное — строка записи, мягкая подсказка «Вопрос для книги» и записи дня. Всё убранное на месте: стрик и статистика — в «Здоровье» (дашборд), фокус виден в самой записи. Кто хочет больше блоков — включает их кнопкой «Настроить» справа вверху.", tag: "improved" },
  ...
  en: {
    ...
    changelog: [
      { t: "A lighter home screen", d: "We removed clutter from “Today” so it doesn't overwhelm: the streak line with the “Open dashboard” button and the “Focus of the day” card are gone. What's left is the essentials — the capture bar, the gentle “A question for your book” nudge and your entries of the day. Nothing is lost: streak and stats live in “Health” (dashboard). Want more blocks? Turn them on with “Customize” in the top right.", tag: "improved" },
