...
// Индексацию ЖДЁМ, а не запускаем вдогонку. На бессерверном хостинге функция
// засыпает сразу после ответа, и незавершённое обещание просто умирает: вещь
// сохранялась, а вектор не считался — до ближайшего подметания через час.
// Лишние 200-300 мс тут дешевле, чем вещь, которую час не найти по смыслу.
