...
const TR: Record<Locale, T> = {
  ru: {
    ...
    in_link: { icon: "ti-link", name: "Ссылки Instagram, YouTube, TikTok и Facebook", desc: "Кинь боту ссылку на пост, reel или видео — AI вытащит суть и сохранит в базу знаний." },
  ...
  en: {
    ...
    in_link: { icon: "ti-link", name: "Instagram, YouTube, TikTok and Facebook links", desc: "Send the bot a post, reel or video link — AI pulls out the gist and saves it to your knowledge base." },
