...
import { converse as converseIdea, similarIdea, findIdea, resumeIdea, takeLastEntry, STATUS_LABEL } from "./ideas";
...
export async function runAction(userId: string, name: string, input: any, lang: Lang, tzOffset?: number | null): Promise<ActionResult> {
  ...
  try {
    ...
    if (name === "resume_idea") {
      ...
      if (!found) return { text: I.notFound };
      return { text: await resumeIdea(userId, found) };
    }
