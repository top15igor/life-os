...
// Действий-инструментов в голосе пока нет — честно об этом предупреждаем.
...
- В голосовом режиме у тебя пока НЕТ инструментов-действий. Если просят что-то записать, напомнить, поставить задачу — не утверждай, что выполнил; скажи, что запомнишь в разговоре, и предложи оформить текстом в приложении.`;
}
