...
const AGENT_NAMES = ["set_reminder", "add_task", "add_goal", "log_weight", "add_dream", "complete_task", "complete_dream", "add_deed", "rename_person", "set_style", "account_info", "ask_knowledge"];
