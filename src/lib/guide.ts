...
const G: Record<Locale, Guide> = {
  ru: {
    ...
    lifehacks: [
      ...
      "Нашёл полезный пост или видео — кинь ссылку (Instagram/YouTube/TikTok/Facebook) боту: AI сохранит суть в «Базу знаний». А фото и документы (чек, гарантия, момент) идут в «Память». Потом всё это можно искать и спрашивать.",
  ...
  en: {
    ...
    lifehacks: [
      ...
      "Found a useful post or video — send the link (Instagram/YouTube/TikTok/Facebook) to the bot: AI saves the gist to your “Knowledge Base”. Photos and documents (receipt, warranty, a moment) go to “Memory”. Then search and ask all of it.",
