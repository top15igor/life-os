...
const G: Record<Locale, Guide> = {
  ru: {
    ...
    cmds: [
      ...
      ["/ask …", "спросить ассистента о своей жизни"],
    ],
  ...
  en: {
    ...
    cmds: [
      ...
      ["/ask …", "ask the assistant about your life"],
    ],
  ...
  uk: {
    ...
    cmds: [
      ...
      ["/ask …", "запитати асистента про своє життя"],
    ],
  ...
  fr: {
    ...
    cmds: [
      ...
      ["/ask …", "demander à l'assistant à propos de ta vie"],
    ],
    sectionsTitle: "Sections",
