...
const G: Record<Locale, Guide> = {
  ru: {
    ...
    lifehacks: [
      ...
      "Добавь LIFE OS на экран «Домой»: в Safari нажми «Поделиться» → «На экран Домой» — откроется как приложение.",
  ...
  en: {
    ...
    lifehacks: [
      ...
      "Add LIFE OS to your home screen: in Safari tap Share → “Add to Home Screen” — it opens like an app.",
  ...
  fr: {
    ...
    lifehacks: [
      ...
      "Ajoute LIFE OS à l'écran d'accueil : dans Safari, appuie sur Partager → « Sur l'écran d'accueil » — il s'ouvre comme une app.",
