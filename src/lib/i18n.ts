...
const dicts: Record<Locale, Dict> = {
  ...
  en: {
    brand: "LIFE OS",
    nav: { today: "Today", guide: "Guide", diary: "Diary", tasks: "Tasks", wellness: "Wellness", plans: "Goals & tasks", health: "Health", energy: "Energy", sport: "Sport", food: "Food", family: "Family", projects: "Projects", insights: "Insights", goals: "Goals", lifebook: "Life Book", people: "People", places: "Places", analytics: "Analytics", biographer: "Biographer" },
  ...
  fr: {
    brand: "LIFE OS",
    nav: { today: "Aujourd'hui", guide: "Guide", diary: "Journal", tasks: "Tâches", wellness: "Bien-être", plans: "Objectifs & tâches", health: "Santé", energy: "Énergie", sport: "Sport", food: "Alimentation", family: "Famille", projects: "Projets", insights: "Insights", goals: "Objectifs", lifebook: "Livre de vie", people: "Personnes", places: "Lieux", analytics: "Analytique", biographer: "Biographe" },
