...
const dicts: Record<Locale, Dict> = {
  ru: {
    brand: "LIFE OS",
    nav: { today: "Сегодня", guide: "Инструкция", diary: "Дневник", tasks: "Задачи", wellness: "Самочувствие", plans: "Цели и задачи", finance: "Деньги", health: "Здоровье", energy: "Энергия", sport: "Спорт", food: "Питание", family: "Семья", projects: "Проекты", insights: "Инсайты", goals: "Цели", lifebook: "Книга жизни", knowledge: "База знаний", books: "Книги", trace: "Мой след", reminders: "Напоминания", memory: "Память", people: "Люди", places: "Места", analytics: "Что заметил AI", lab: "Лаборатория", biographer: "Биограф", wishlist: "Вишлист", share: "Поделиться", paths: "Мои пути", profile: "Профиль" },
  ...
  uk: {
    brand: "LIFE OS",
    nav: { today: "Сьогодні", guide: "Інструкція", diary: "Щоденник", tasks: "Завдання", wellness: "Самопочуття", plans: "Цілі та завдання", finance: "Гроші", health: "Здоров'я", energy: "Енергія", sport: "Спорт", food: "Харчування", family: "Сім'я", projects: "Проєкти", insights: "Інсайти", goals: "Цілі", lifebook: "Книга життя", knowledge: "База знань", books: "Книги", trace: "Мій слід", reminders: "Нагадування", memory: "Пам'ять", people: "Люди", places: "Місця", analytics: "Що помітив AI", lab: "Лабораторія", biographer: "Біограф", wishlist: "Вішліст", share: "Поділитися", paths: "Мої шляхи", profile: "Профіль" },
  ...
  fr: {
    brand: "LIFE OS",
    nav: { today: "Aujourd'hui", guide: "Guide", diary: "Journal", tasks: "Tâches", wellness: "Bien-être", plans: "Objectifs & tâches", finance: "Argent", health: "Santé", energy: "Énergie", sport: "Sport", food: "Alimentation", family: "Famille", projects: "Projets", insights: "Insights", goals: "Objectifs", lifebook: "Livre de vie", knowledge: "Base de connaissances", books: "Livres", trace: "Mon empreinte", reminders: "Rappels", memory: "Mémoire", people: "Personnes", places: "Lieux", analytics: "Vu par l'IA", lab: "Labo", biographer: "Biographe", wishlist: "Liste de souhaits", share: "Partager", paths: "Mes chemins", profile: "Profil" },
