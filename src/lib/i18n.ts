...
const dicts: Record<Locale, Dict> = {
  ...
  en: {
    brand: "LIFE OS",
    nav: { today: "Today", dashboard: "Dashboard", guide: "Guide", diary: "Diary", tasks: "Tasks", wellness: "Health", plans: "Goals & tasks", finance: "Money", health: "Health", energy: "Energy", sport: "Sport", food: "Food", family: "Family", projects: "Projects", insights: "Insights", goals: "Goals", lifebook: "Life Book", knowledge: "Knowledge", books: "Media", trace: "My Trace", reminders: "Reminders", notes: "Notes", memory: "Memory", sort: "Sort it out", people: "People", places: "Travels", analytics: "Life Intelligence", lab: "Lab", biographer: "Biographer", wishlist: "Wishlist", share: "Share", paths: "My paths", ideas: "Ideas", profile: "Profile" },
  ...
  fr: {
    brand: "LIFE OS",
    nav: { today: "Aujourd'hui", dashboard: "Tableau de bord", guide: "Guide", diary: "Journal", tasks: "Tâches", wellness: "Santé", plans: "Objectifs & tâches", finance: "Argent", health: "Santé", energy: "Énergie", sport: "Sport", food: "Alimentation", family: "Famille", projects: "Projets", insights: "Insights", goals: "Objectifs", lifebook: "Livre de vie", knowledge: "Base de connaissances", books: "Médiathèque", trace: "Mon empreinte", reminders: "Rappels", notes: "Notes", memory: "Mémoire", sort: "À trier", people: "Personnes", places: "Voyages", analytics: "Vu par l'IA", lab: "Labo", biographer: "Biographe", wishlist: "Liste de souhaits", share: "Partager", paths: "Mes chemins", ideas: "Id\u00e9es", profile: "Profil" },
