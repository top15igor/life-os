...
const dicts: Record<Locale, Dict> = {
  ru: {
    brand: "LIFE OS",
    nav: { today: "Сегодня", dashboard: "Дашборд", guide: "Инструкция", diary: "Дневник", tasks: "Задачи", wellness: "Здоровье", plans: "Цели и задачи", finance: "Деньги", health: "Здоровье", energy: "Энергия", sport: "Спорт", food: "Питание", family: "Семья", projects: "Проекты", insights: "Инсайты", goals: "Цели", lifebook: "Книга жизни", knowledge: "База знаний", books: "Медиатека", trace: "Мой след", reminders: "Напоминания", notes: "Заметки", memory: "Память", sort: "Разобрать", people: "Люди", places: "Путешествия", map: "Карта жизни", analytics: "Что заметил AI", lab: "Лаборатория", biographer: "Биограф", wishlist: "Вишлист", share: "Поделиться", paths: "Мои пути", ideas: "Идеи", profile: "Профиль" },
  ...
  en: {
    brand: "LIFE OS",
    nav: { today: "Today", dashboard: "Dashboard", guide: "Guide", diary: "Diary", tasks: "Tasks", wellness: "Health", plans: "Goals & tasks", finance: "Money", health: "Health", energy: "Energy", sport: "Sport", food: "Food", family: "Family", projects: "Projects", insights: "Insights", goals: "Goals", lifebook: "Life Book", knowledge: "Knowledge", books: "Media", trace: "My Trace", reminders: "Reminders", notes: "Notes", memory: "Memory", sort: "Sort it out", people: "People", places: "Travels", map: "Life map", analytics: "Life Intelligence", lab: "Lab", biographer: "Biographer", wishlist: "Wishlist", share: "Share", paths: "My paths", ideas: "Ideas", profile: "Profile" },
  ...
  uk: {
    brand: "LIFE OS",
    nav: { today: "Сьогодні", dashboard: "Дашборд", guide: "Інструкція", diary: "Щоденник", tasks: "Завдання", wellness: "Здоров'я", plans: "Цілі та завдання", finance: "Гроші", health: "Здоров'я", energy: "Енергія", sport: "Спорт", food: "Харчування", family: "Сім'я", projects: "Проєкти", insights: "Інсайти", goals: "Цілі", lifebook: "Книга життя", knowledge: "База знань", books: "Медиатека", trace: "Мій слід", reminders: "Нагадування", notes: "Нотатки", memory: "Пам'ять", sort: "Розібрати", people: "Люди", places: "Подорожі", map: "Карта життя", analytics: "Що помітив AI", lab: "Лабораторія", biographer: "Біограф", wishlist: "Вішліст", share: "Поділитися", paths: "Мої шляхи", ideas: "Ідеї", profile: "Профіль" },
  ...
  fr: {
    brand: "LIFE OS",
    nav: { today: "Aujourd'hui", dashboard: "Tableau de bord", guide: "Guide", diary: "Journal", tasks: "Tâches", wellness: "Santé", plans: "Objectifs & tâches", finance: "Argent", health: "Santé", energy: "Énergie", sport: "Sport", food: "Alimentation", family: "Famille", projects: "Projets", insights: "Insights", goals: "Objectifs", lifebook: "Livre de vie", knowledge: "Base de connaissances", books: "Médiathèque", trace: "Mon empreinte", reminders: "Rappels", notes: "Notes", memory: "Mémoire", sort: "À trier", people: "Personnes", places: "Voyages", map: "Carte de vie", analytics: "Vu par l'IA", lab: "Labo", biographer: "Biographe", wishlist: "Liste de souhaits", share: "Partager", paths: "Mes chemins", ideas: "Id\u00e9es", profile: "Profil" },
  ...
  es: {
    brand: "LIFE OS",
    nav: { today: "Hoy", dashboard: "Panel", guide: "Guía", diary: "Diario", tasks: "Tareas", wellness: "Salud", plans: "Metas y tareas", finance: "Dinero", health: "Salud", energy: "Energía", sport: "Deporte", food: "Alimentación", family: "Familia", projects: "Proyectos", insights: "Ideas", goals: "Metas", lifebook: "Libro de la vida", knowledge: "Base de conocimiento", books: "Mediateca", trace: "Mi huella", reminders: "Recordatorios", notes: "Notas", memory: "Memoria", sort: "Por ordenar", people: "Personas", places: "Viajes", map: "Mapa de vida", analytics: "Lo que notó la IA", lab: "Laboratorio", biographer: "Biógrafo", wishlist: "Lista de deseos", share: "Compartir", paths: "Mis caminos", ideas: "Ideas", profile: "Perfil" },
