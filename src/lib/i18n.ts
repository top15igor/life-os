...
const dicts: Record<Locale, Dict> = {
  ...
  en: {
    brand: "LIFE OS",
    nav: { today: "Today", guide: "Guide", diary: "Diary", tasks: "Tasks", wellness: "Wellness", plans: "Goals & tasks", health: "Health", energy: "Energy", sport: "Sport", food: "Food", family: "Family", projects: "Projects", insights: "Insights", goals: "Goals", lifebook: "Life Book", trace: "My Trace", memory: "Memory", people: "People", places: "Places", analytics: "Life Intelligence", lab: "Lab", biographer: "Biographer", profile: "Profile" },
