...
const dicts: Record<Locale, Dict> = {
  ru: {
    brand: "LIFE OS",
    nav: { today: "Сегодня", guide: "Инструкция", diary: "Дневник", tasks: "Задачи", wellness: "Самочувствие", plans: "Цели и задачи", finance: "Деньги", health: "Здоровье", energy: "Энергия", sport: "Спорт", food: "Питание", family: "Семья", projects: "Проекты", insights: "Инсайты", goals: "Цели", lifebook: "Книга жизни", knowledge: "База знаний", books: "Книги", trace: "Мой след", memory: "Память", people: "Люди", places: "Места", analytics: "Что заметил AI", lab: "Лаборатория", biographer: "Биограф", wishlist: "Вишлист", share: "Поделиться", paths: "Мои пути", profile: "Профиль" },
  ...
  en: {
    brand: "LIFE OS",
    nav: { today: "Today", guide: "Guide", diary: "Diary", tasks: "Tasks", wellness: "Wellness", plans: "Goals & tasks", finance: "Money", health: "Health", energy: "Energy", sport: "Sport", food: "Food", family: "Family", projects: "Projects", insights: "Insights", goals: "Goals", lifebook: "Life Book", knowledge: "Knowledge", books: "Books", trace: "My Trace", memory: "Memory", people: "People", places: "Places", analytics: "Life Intelligence", lab: "Lab", biographer: "Biographer", wishlist: "Wishlist", share: "Share", paths: "My paths", profile: "Profile" },
  ...
  uk: {
    brand: "LIFE OS",
    nav: { today: "Сьогодні", guide: "Інструкція", diary: "Щоденник", tasks: "Завдання", wellness: "Самопочуття", plans: "Цілі та завдання", finance: "Гроші", health: "Здоров'я", energy: "Енергія", sport: "Спорт", food: "Харчування", family: "Сім'я", projects: "Проєкти", insights: "Інсайти", goals: "Цілі", lifebook: "Книга життя", knowledge: "База знань", books: "Книги", trace: "Мій слід", memory: "Пам'ять", people: "Люди", places: "Місця", analytics: "Що помітив AI", lab: "Лабораторія", biographer: "Біограф", wishlist: "Вішліст", share: "Поділитися", paths: "Мої шляхи", profile: "Профіль" },
