...
const dicts: Record<Locale, Dict> = {
  ru: {
    brand: "LIFE OS",
    nav: { today: "Сегодня", guide: "Инструкция", diary: "Дневник", tasks: "Задачи", wellness: "Самочувствие", plans: "Цели и задачи", health: "Здоровье", energy: "Энергия", sport: "Спорт", food: "Питание", family: "Семья", projects: "Проекты", insights: "Инсайты", goals: "Цели", lifebook: "Книга жизни", trace: "Мой след", memory: "Память", people: "Люди", places: "Места", analytics: "Что заметил AI", lab: "Лаборатория", biographer: "Биограф", share: "Поделиться", profile: "Профиль" },
  ...
  en: {
    brand: "LIFE OS",
    nav: { today: "Today", guide: "Guide", diary: "Diary", tasks: "Tasks", wellness: "Wellness", plans: "Goals & tasks", health: "Health", energy: "Energy", sport: "Sport", food: "Food", family: "Family", projects: "Projects", insights: "Insights", goals: "Goals", lifebook: "Life Book", trace: "My Trace", memory: "Memory", people: "People", places: "Places", analytics: "Life Intelligence", lab: "Lab", biographer: "Biographer", share: "Share", profile: "Profile" },
  ...
  uk: {
    brand: "LIFE OS",
    nav: { today: "Сьогодні", guide: "Інструкція", diary: "Щоденник", tasks: "Завдання", wellness: "Самопочуття", plans: "Цілі та завдання", health: "Здоров'я", energy: "Енергія", sport: "Спорт", food: "Харчування", family: "Сім'я", projects: "Проєкти", insights: "Інсайти", goals: "Цілі", lifebook: "Книга життя", trace: "Мій слід", memory: "Пам'ять", people: "Люди", places: "Місця", analytics: "Що помітив AI", lab: "Лабораторія", biographer: "Біограф", share: "Поділитися", profile: "Профіль" },
  ...
  fr: {
    brand: "LIFE OS",
    nav: { today: "Aujourd'hui", guide: "Guide", diary: "Journal", tasks: "Tâches", wellness: "Bien-être", plans: "Objectifs & tâches", health: "Santé", energy: "Énergie", sport: "Sport", food: "Alimentation", family: "Famille", projects: "Projets", insights: "Insights", goals: "Objectifs", lifebook: "Livre de vie", trace: "Mon empreinte", memory: "Mémoire", people: "Personnes", places: "Lieux", analytics: "Vu par l'IA", lab: "Labo", biographer: "Biographe", share: "Partager", profile: "Profil" },
