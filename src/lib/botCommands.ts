...
const COMMANDS_UK = [
  ...
  { command: "map", description: "🗺 Карта життя — де ти був" },
  { command: "capsule", description: "⏳ Капсула часу — лист у майбутнє" },
  { command: "help", description: "Допомога — що вміє бот" },
  { command: "problem", description: "🛠 Повідомити про проблему або глюк" },
