export const NAV: { key: string; href: string; icon: string }[] = [
  ...
  { key: "food", href: "/food", icon: "ti-salad" },
  { key: "family", href: "/family", icon: "ti-users" },
  { key: "projects", href: "/projects", icon: "ti-briefcase" },
  { key: "insights", href: "/insights", icon: "ti-bulb" },
  { key: "goals", href: "/goals", icon: "ti-target" },
...
export const MOBILE_PRIMARY = ["today", "diary", "health", "biographer"];
