...
// Лента «Сегодня» — домашний экран пользователя. Рендерится по адресу /i/<username>.
export default async function HomeBody() {
  ...
  // Время суток — тот же источник и пороги, что и в greeting() (Europe/Kyiv), чтобы не противоречить приветствию.
