...
const KIND_LABEL: Record<string, Record<string, string>> = {
  ...
  es: { help: "Ayuda", support: "Apoyo", care: "Cuidado", gift: "Regalo", knowledge: "Conocimiento", volunteer: "Voluntariado", family: "Familia", community: "Comunidad", other: "Buena acción" },
};
...
const S: Record<string, any> = {
  ...
  es: { tabs: ["Resumen", "Buenas acciones", "Promesas"], warm: "Estás dejando una huella buena.", warmEmpty: "Tu huella apenas empieza.", sub: "Lo importante no es la cantidad, sino las historias que continúan después.", weekLabel: "Esta semana", deedsW: "buenas acciones", peopleW: "personas ayudadas", keptW: "promesas cumplidas", grat: (n: number) => `🙏 Agradecimientos guardados: ${n}`, attention: "Necesita atención", chronicle: "Crónica de la huella", openP: "Promesas abiertas", doneP: "Promesas cumplidas", deedsEmpty: "Aquí aparecerán las historias de lo que mejoró gracias a ti. Solo cuenta a quién ayudaste.", openEmpty: "No hay promesas abiertas.", doneStr: "Hecho", keptStr: "Hecho ✓" },
};
