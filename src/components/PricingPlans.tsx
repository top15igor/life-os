...
const PLANS: Record<string, any[]> = {
  ...
  es: [
    { key: "free", name: "Inicio", price: "0", tagline: "Pruébalo y crea el hábito", features: ["Hasta 30 entradas al mes", "Voz y texto en Telegram", "Feed, búsqueda, etiquetas, estado de ánimo", "Gráficos básicos de bienestar"], cta: false },
    { key: "pro", name: "Pro", price: "9.99", tagline: "Todo el diario, sin límites", popular: true, features: ["Entradas ilimitadas (techo justo ~300/mes)", "IA con insights: patrones, espejo de tu vida", "Biógrafo IA: pregunta sobre tu vida", "Libro de vida, Mapa de sueños, seguimiento de peso", "Exporta todos tus datos · soporte"], cta: true },
    { key: "premium", name: "Premium", price: "19.99", tagline: "Para la familia y un libro impreso", features: ["Todo lo de Pro, sin techo de entradas", "📖 Libro de vida impreso (imprenta + envío)", "Acceso familiar (próximamente)", "Acceso anticipado a nuevas funciones", "Soporte prioritario"], cta: true },
  ],
};
