...
const D: Record<Locale, Dict> = {
  ru: {
    ...
    heroP: "Живи как живёшь. Рассказывай — голосом или текстом. AI соберёт из этого твою историю: дневник, книгу жизни, цели, здоровье, людей и места. Так остаётся след.",
  ...
  en: {
    ...
    heroP: "Live your life. Tell it — by voice or text. AI turns it into your story: a diary, a book of life, goals, health, people and places. That's how you leave your mark.",
  ...
  uk: {
    ...
    heroP: "Живи як живеш. Розповідай — голосом або текстом. AI збере з цього твою історію: щоденник, книгу життя, цілі, здоров'я, людей і місця. Так лишається слід.",
  ...
  fr: {
    ...
    heroP: "Vis ta vie. Raconte — à la voix ou au texte. L'IA en fait ton histoire : journal, livre de vie, objectifs, santé, gens et lieux. C'est ainsi qu'on laisse une trace.",
  ...
  es: {
    ...
    heroP: "Vive tu vida. Cuéntala — por voz o texto. La IA la convierte en tu historia: un diario, un libro de vida, metas, salud, personas y lugares. Así queda tu huella.",
...
export default function AboutModern({ locale, intl, isAuthed, loginHref }: { locale: Locale; intl: string; isAuthed: boolean; loginHref: string; refCode?: string }) {
