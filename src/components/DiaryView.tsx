...
const STR: Record<string, any> = {
  ...
  es: { periodAll: "Todo el tiempo", today: "Hoy", week: "7 días", month: "30 días", moodHigh: "Alto 8–10", moodMid: "Medio 5–7", moodLow: "Bajo 1–4", empty: "No se encontró nada con los filtros seleccionados.", reset: "Restablecer", edit: "Editar", del: "Eliminar", delConfirm: "¿Eliminar esta entrada? También se eliminarán sus tareas, buenas acciones y promesas. La acción no se puede deshacer.", editTitle: "Editar entrada", editHint: "Corrige el texto — la IA volverá a clasificarlo por categorías, etiquetas y estado de ánimo.", save: "Guardar", cancel: "Cancelar", recalc: "Recalculando…", emptyText: "El texto no puede estar vacío." },
};
...
const CAL: Record<string, any> = {
  ...
  es: { month: "Mes", week: "Semana", today: "Hoy", dayEmpty: "No hay entradas este día.", allMonth: "Mostrar todo el mes", allWeek: "Mostrar toda la semana" },
};
