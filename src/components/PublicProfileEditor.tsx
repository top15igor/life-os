...
const STR: Record<string, any> = {
  ...
  es: { title: "Página pública", sub: "Un escaparate de tus logros con un enlace — como un perfil de Strava. Solo salen los números y lo que actives tú. Aquí no hay contenido del diario.", enable: "Activar página pública", slugLabel: "Dirección de la página", bioLabel: "Sobre ti (opcional)", bioPh: "Por ej.: «Vivo con conciencia, corro por las mañanas»", showLabel: "Qué mostrar", b_voice: "Notas de voz", b_deeds: "Buenas acciones", b_dreams: "Sueños cumplidos", b_streak: "Racha", save: "Guardar", saving: "Guardando…", saved: "Guardado ✓", taken: "Esa dirección ya está en uso, elige otra", badSlug: "Dirección: 3–30 caracteres, letras latinas, números, guion", yourLink: "Tu enlace", copy: "Copiar", copied: "Copiado ✓", open: "Abrir", offHint: "La página está apagada — nadie puede verla." },
};
