...
export default function KnowledgeManager({ initial, locale }: { initial: SavedItem[]; locale: string }) {
  ...
  async function add() {
    const u = addUrl.trim();
    if (!/instagram\.com|youtube\.com|youtu\.be/i.test(u)) { setAddErr(s.badUrl); return; }
