...
const STR: Record<string, any> = {
  ru: { addPh: "Ссылка на Instagram или YouTube…", add: "Добавить", adding: "Добавляю…", badUrl: "Нужна ссылка Instagram или YouTube", limited: "Закончился месячный лимит — попробуй позже", searchPh: "Поиск по заголовку, тексту, тегам…", favOnly: "Избранное", ask: "Спросить по базе", askPh: "Например: что я сохранял про спину?", asking: "Думаю…", points: "Главное", video: "Видео", download: "Скачать видео", open: "Открыть в Instagram", openYt: "Открыть на YouTube", yt: "YouTube", reel: "Reels", post: "Instagram", edit: "Редактировать", save: "Сохранить", cancel: "Отмена", delete: "Удалить", del2: "Удалить эту карточку?", folder: "Папка", note: "Заметка", notePh: "Зачем сохранил, что применить…", title: "Заголовок", summary: "Описание", done: "Применил", undone: "Применить", fav: "В избранное", unfav: "В избранном", empty: "Ничего не найдено по фильтру.", applied: "Применил", clear: "Сбросить", newFolder: "Новая папка…", tidy: "Навести порядок", tidying: "Раскладываю…", translate: "Перевести базу", translating: "Перевожу…", translateConfirm: "Перевести все карточки на язык интерфейса? Это пересоберёт заголовки и описания.", addFailed: "Не удалось распаковать пост. Попробуй ещё раз или пришли ссылку боту.", onbTitle: "Как наполнить базу знаний", onbSteps: ["Нашёл полезный пост, reels или видео — открой его в Instagram или YouTube.", "Нажми «Поделиться» → «Копировать ссылку».", "Вставь ссылку в поле выше или просто пришли её боту в Telegram — AI разберёт суть и сохранит сюда. Потом ищи по смыслу и спрашивай свою базу."] },
  en: { addPh: "Instagram or YouTube link…", add: "Add", adding: "Adding…", badUrl: "Need an Instagram or YouTube link", limited: "Monthly limit reached — try later", searchPh: "Search by title, text, tags…", favOnly: "Favorites", ask: "Ask your base", askPh: "e.g. what did I save about back pain?", asking: "Thinking…", points: "Key points", video: "Video", download: "Download video", open: "Open in Instagram", openYt: "Open on YouTube", yt: "YouTube", reel: "Reels", post: "Instagram", edit: "Edit", save: "Save", cancel: "Cancel", delete: "Delete", del2: "Delete this card?", folder: "Folder", note: "Note", notePh: "Why you saved it, what to apply…", title: "Title", summary: "Summary", done: "Applied", undone: "Mark applied", fav: "Add to favorites", unfav: "Favorited", empty: "Nothing matches the filter.", applied: "Applied", clear: "Clear", newFolder: "New folder…", tidy: "Tidy folders", tidying: "Tidying…", translate: "Translate base", translating: "Translating…", translateConfirm: "Translate all cards to the interface language? This will rebuild titles and summaries.", addFailed: "Couldn't unpack the post. Try again or send the link to the bot.", onbTitle: "How to fill your knowledge base", onbSteps: ["Found a useful post, reel or video — open it in Instagram or YouTube.", "Tap Share → Copy link.", "Paste the link in the field above, or just send it to the bot in Telegram — AI parses the gist and saves it here. Then search by meaning and ask your base."] },
  uk: { addPh: "Посилання на Instagram або YouTube…", add: "Додати", adding: "Додаю…", badUrl: "Потрібне посилання Instagram або YouTube", limited: "Закінчився місячний ліміт — спробуй пізніше", searchPh: "Пошук за заголовком, текстом, тегами…", favOnly: "Обране", ask: "Спитати базу", askPh: "Напр.: що я зберігав про спину?", asking: "Думаю…", points: "Головне", video: "Відео", download: "Завантажити відео", open: "Відкрити в Instagram", openYt: "Відкрити на YouTube", yt: "YouTube", reel: "Reels", post: "Instagram", edit: "Редагувати", save: "Зберегти", cancel: "Скасувати", delete: "Видалити", del2: "Видалити цю картку?", folder: "Папка", note: "Нотатка", notePh: "Навіщо зберіг, що застосувати…", title: "Заголовок", summary: "Опис", done: "Застосував", undone: "Застосувати", fav: "В обране", unfav: "В обраному", empty: "Нічого не знайдено.", applied: "Застосував", clear: "Скинути", newFolder: "Нова папка…", tidy: "Навести лад", tidying: "Розкладаю…", translate: "Перекласти базу", translating: "Перекладаю…", translateConfirm: "Перекласти всі картки мовою інтерфейсу? Це перезбере заголовки й описи.", addFailed: "Не вдалося розпакувати пост. Спробуй ще раз або надішли посилання боту.", onbTitle: "Як наповнити базу знань", onbSteps: ["Знайшов корисний пост, reels чи відео — відкрий його в Instagram або YouTube.", "Натисни «Поділитися» → «Скопіювати посилання».", "Встав посилання в поле вище або просто надішли його боту в Telegram — AI розбере суть і збереже сюди. Потім шукай за змістом і питай свою базу."] },
  fr: { addPh: "Lien Instagram ou YouTube…", add: "Ajouter", adding: "Ajout…", badUrl: "Lien Instagram ou YouTube requis", limited: "Limite mensuelle atteinte — réessaie plus tard", searchPh: "Recherche par titre, texte, tags…", favOnly: "Favoris", ask: "Demander à ta base", askPh: "ex. : qu'ai-je enregistré sur le dos ?", asking: "Réflexion…", points: "Points clés", video: "Vidéo", download: "Télécharger la vidéo", open: "Ouvrir dans Instagram", openYt: "Ouvrir sur YouTube", yt: "YouTube", reel: "Reels", post: "Instagram", edit: "Modifier", save: "Enregistrer", cancel: "Annuler", delete: "Supprimer", del2: "Supprimer cette carte ?", folder: "Dossier", note: "Note", notePh: "Pourquoi tu l'as gardé, quoi appliquer…", title: "Titre", summary: "Résumé", done: "Appliqué", undone: "Marquer appliqué", fav: "Ajouter aux favoris", unfav: "En favori", empty: "Aucun résultat.", applied: "Appliqué", clear: "Effacer", newFolder: "Nouveau dossier…", tidy: "Ranger", tidying: "Rangement…", translate: "Traduire la base", translating: "Traduction…", translateConfirm: "Traduire toutes les cartes dans la langue de l'interface ? Cela reconstruira titres et résumés.", addFailed: "Impossible de décortiquer le post. Réessaie ou envoie le lien au bot.", onbTitle: "Comment remplir ta base de connaissances", onbSteps: ["Tu as trouvé un post, reel ou une vidéo utile — ouvre-le dans Instagram ou YouTube.", "Touche Partager → Copier le lien.", "Colle le lien dans le champ ci-dessus, ou envoie-le au bot dans Telegram — l'IA en extrait l'essentiel et l'enregistre ici. Ensuite, recherche par sens et interroge ta base."] },
  es: { addPh: "Enlace de Instagram o YouTube…", add: "Añadir", adding: "Añadiendo…", badUrl: "Necesitas un enlace de Instagram o YouTube", limited: "Se acabó el límite mensual — inténtalo más tarde", searchPh: "Buscar por título, texto, etiquetas…", favOnly: "Favoritos", ask: "Pregúntale a tu base", askPh: "Por ejemplo: ¿qué guardé sobre el dolor de espalda?", asking: "Pensando…", points: "Lo esencial", video: "Video", download: "Descargar video", open: "Abrir en Instagram", openYt: "Abrir en YouTube", yt: "YouTube", reel: "Reels", post: "Instagram", edit: "Editar", save: "Guardar", cancel: "Cancelar", delete: "Eliminar", del2: "¿Eliminar esta tarjeta?", folder: "Carpeta", note: "Nota", notePh: "Por qué lo guardaste, qué aplicar…", title: "Título", summary: "Resumen", done: "Aplicado", undone: "Marcar como aplicado", fav: "Añadir a favoritos", unfav: "En favoritos", empty: "No hay nada que coincida con el filtro.", applied: "Aplicado", clear: "Borrar", newFolder: "Nueva carpeta…", tidy: "Ordenar carpetas", tidying: "Ordenando…", translate: "Traducir la base", translating: "Traduciendo…", translateConfirm: "¿Traducir todas las tarjetas al idioma de la interfaz? Esto reconstruirá los títulos y resúmenes.", addFailed: "No se pudo procesar la publicación. Inténtalo de nuevo o envía el enlace al bot.", onbTitle: "Cómo llenar tu base de conocimiento", onbSteps: ["Encontraste una publicación, reel o video útil — ábrelo en Instagram o YouTube.", "Toca «Compartir» → «Copiar enlace».", "Pega el enlace en el campo de arriba, o simplemente envíaselo al bot en Telegram — la IA analizará la idea y la guardará aquí. Luego busca por significado y pregúntale a tu base."] },
};
...
export default function KnowledgeManager({ initial, locale }: { initial: SavedItem[]; locale: string }) {
  const s = STR[locale] || STR.ru;
  const isYt = (it: SavedItem) => it.source === "youtube";
  const srcName = (it: SavedItem) => (isYt(it) ? s.yt : it.kind === "reel" ? s.reel : s.post);
  const isVideo = (it: SavedItem) => isYt(it) || it.kind === "reel";
  ...
  async function add() {
    const u = addUrl.trim();
    if (!/instagram\.com|youtube\.com|youtu\.be|tiktok\.com/i.test(u)) { setAddErr(s.badUrl); return; }
    setAddErr(""); setAddBusy(true);
    const j = await api("add", { url: u });
    setAddBusy(false);
    if (j?.ok && j.item) { setItems((p) => [j.item, ...p]); setAddUrl(""); return; }
    // Ссылка валидная — значит проблема с распаковкой/лимитом, а не «плохая ссылка».
    const e = j?.error;
    setAddErr(e === "bad_url" ? s.badUrl : e === "limited" ? s.limited : s.addFailed);
  }
  ...
  const Thumb = ({ it, h }: { it: SavedItem; h: number }) => (
    <div style={{ position: "relative" }}>
      ...
      {it.video_url ? (
        <span title={s.video} style={{ position: "absolute", left: 8, bottom: 8, width: 30, height: 30, borderRadius: 999, background: "rgba(0,0,0,.55)", color: "#fff", display: "inline-flex", alignItems: "center", justifyContent: "center", fontSize: 16 }}>
  ...
  return (
    <div>
      ...
      {filtered.length === 0 ? (
        items.length === 0 ? (
          /* Совсем пусто — наглядный онбординг с шагами. */
          <div style={{ padding: "26px 22px", border: "1px solid var(--border)", borderRadius: 16, background: "var(--surface)" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
              <i className="ti ti-bookmarks" style={{ fontSize: 24, color: "#6d5efc" }} />
              <div style={{ fontSize: 16, fontWeight: 600 }}>{s.onbTitle}</div>
            </div>
            <div style={{ display: "flex", flexDirection: "column", gap: 13 }}>
              {s.onbSteps.map((step: string, i: number) => (
                <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: 12 }}>
                  <span style={{ flexShrink: 0, width: 26, height: 26, borderRadius: 99, background: "var(--accent-bg)", color: "var(--accent)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 13.5, fontWeight: 700 }}>{i + 1}</span>
                  <span style={{ fontSize: 14, color: "var(--text-2)", lineHeight: 1.5, paddingTop: 3 }}>{step}</span>
                </div>
              ))}
            </div>
          </div>
        ) : (
          <div style={{ padding: 26, border: "1px solid var(--border)", borderRadius: 16, background: "var(--surface)", color: "var(--text-3)", textAlign: "center", lineHeight: 1.6 }}>{s.empty}</div>
        )
      ) : (
              ...
              {list.map((it) => (
                ...
                >
                  <div style={{ position: "relative" }}>
                    ...
                    {isVideo(it) ? <span style={{ position: "absolute", bottom: 7, right: 7, background: isYt(it) ? "rgba(220,38,38,.85)" : "rgba(0,0,0,.6)", color: "#fff", borderRadius: 999, padding: "2px 7px", fontSize: 10 }}><i className={`ti ${isYt(it) ? "ti-brand-youtube" : "ti-player-play-filled"}`} style={{ fontSize: 10 }} /> {srcName(it)}</span> : null}
                  </div>
              ...
              {editing ? (
                ...
                <>
                  <div style={{ display: "flex", alignItems: "center", gap: 6, fontSize: 12, color: "var(--text-3)", marginBottom: 8 }}>
                    <i className={`ti ${isYt(open) ? "ti-brand-youtube" : open.kind === "reel" ? "ti-video" : "ti-photo"}`} />
                    <span>{srcName(open)}</span>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 14, marginTop: 18, flexWrap: "wrap" }}>
                    {open.url ? <a href={open.url} target="_blank" rel="noopener noreferrer" style={{ display: "inline-flex", alignItems: "center", gap: 6, fontSize: 13, color: "#6d5efc", textDecoration: "none", fontWeight: 600 }}><i className={`ti ${isYt(open) ? "ti-brand-youtube" : "ti-brand-instagram"}`} style={{ fontSize: 16 }} /> {isYt(open) ? s.openYt : s.open}</a> : null}
                    {open.video_url ? <a href={open.video_url} download target="_blank" rel="noopener noreferrer" style={{ display: "inline-flex", alignItems: "center", gap: 6, fontSize: 13, color: "#6d5efc", textDecoration: "none", fontWeight: 600 }}><i className="ti ti-download" style={{ fontSize: 16 }} /> {s.download}</a> : null}
