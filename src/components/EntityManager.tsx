...
const STR: Record<string, any> = {
  ...
  es: { manage: "Editar", rename: "Renombrar", merge: "Combinar", hide: "Ocultar", unhide: "Restaurar", save: "Guardar", cancel: "Cancelar", mergeInto: "Combinar con:", mergeNote: "Todas las menciones pasan al elegido, el duplicado desaparece.", noOthers: "No hay otros con quien combinar", hiddenSec: "Ocultos", needSql: "Para ocultar — ejecuta el SQL (entities_hidden.sql).", renamePh: "Nombre", onMap: "En el mapa" },
};
