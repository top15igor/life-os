...
export default function MemoryArchive({ initial, locale, catLabels: catLabelsInit }: { initial: Memory[]; locale: string; catLabels?: Record<string, string> }) {
  ...
  const catName = (key: string) => catLabels[key] || s.catNames[key] || key;
