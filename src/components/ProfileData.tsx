...
const STR: Record<string, { hint: string; exportBtn: string; obsidianBtn: string; obsidianHint: string; openCode: string }> = {
  ru: { hint: "Всё, что ты доверил LIFE OS — записи, финансы, книги, здоровье, настроение, путешествия, память — одним файлом, в любой момент. А код LIFE OS открыт: можешь сам проверить, что мы делаем с данными.", exportBtn: "Скачать все мои данные", obsidianBtn: "Скачать для Obsidian (Markdown)", obsidianHint: "Хочешь хранить всё у себя? Скачай дневник папкой Markdown-файлов и открой в Obsidian — данные станут полностью твоими, без зависимости от нас.", openCode: "Открытый код на GitHub" },
