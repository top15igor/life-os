...
const STR: Record<string, { title: string; hint: string; blocksTitle: string; done: string; p: Record<string, string>; b: Record<string, string> }> = {
  ...
  es: { title: "Personalizar el inicio", hint: "Se aplica al instante — se ve en la página.", blocksTitle: "Qué bloques mostrar", done: "Listo", p: { mindful: "Consciencia plena", focus: "Enfoque y metas", trace: "Huella amable", balance: "Equilibrio de vida", minimal: "Mínimo", custom: "Arma la tuya" }, b: { book: "Mi libro de vida", habit: "Racha", trace: "Mi huella de hoy", promises: "Promesas", traceWeek: "Huella de la semana", context: "Contexto del día", metrics: "Bienestar", changes: "Qué cambió", focus: "Foco del día", stories: "Historias y proyectos", tasks: "Tareas", gratitude: "Gratitud" } },
};
