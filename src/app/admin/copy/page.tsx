...
Сохранись — по одной записи в день, чтобы было куда вернуться.
👉 life-os.today`;

const TAGLINES = [
  "Сохранись. Фотографии хранят, как ты выглядел. LIFE OS — каким ты был.",
  ...
  "Ты помнишь про клиентов лучше, чем про свою жизнь. LIFE OS — CRM наоборот: помнит тебя.",
];
...
const WHY = [
  ...
  ["Чтобы было куда вернуться", "Каждый день — ещё одна страница, которая не исчезнет. То, что останется тем, кто будет после."],
];
