  ...
  return (
    <div className="shell">
      ...
      <main className="main" style={{ maxWidth: 760 }}>
        ...
        <P>
          Прогнать самопроверку целиком: <code>/api/selftest?mode=full</code>. Запустить исследователя разово:{" "}
          <code>/api/probe?n=1</code>. Получить разбор за последние часы: <code>/api/diagnose?hours=3</code>.
          Все три открываются в браузере, где ты вошёл владельцем.
        </P>
        <P>
