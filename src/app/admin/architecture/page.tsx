...
const BACKUPS = [
  ["Вся база · еженедельно", "Каждое воскресенье крон собирает дамп ВСЕХ таблиц (все пользователи) в .zip с JSON-файлами и шлёт владельцу в Telegram. Ручной запуск: /api/cron?dbdump=<секрет>. Восстановление — вставить JSON обратно в Supabase.", "Данные людей не зависят от одного сервиса"],
