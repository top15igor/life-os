      ...
      <main className="main">
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 12, marginBottom: 24 }}>
          ...
          <Link href="/admin/tasks" className="card" style={{ display: "flex", alignItems: "center", gap: 12, background: "var(--accent-bg)", border: "1px solid var(--accent)" }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ fontSize: 15, fontWeight: 600, color: "var(--accent-text)" }}>Отложенные задачи</div>
              <div style={{ fontSize: 12.5, color: "var(--text-2)" }}>Что отложил на потом — идеи и доработки, чтобы не забыть и реализовать позже</div>
            </div>
            <i className="ti ti-arrow-right" style={{ color: "var(--accent)", fontSize: 18 }} />
          </Link>
          <Link href="/admin/health" className="card" style={{ display: "flex", alignItems: "center", gap: 12, background: "var(--accent-bg)", border: "1px solid var(--accent)" }}>
            <i className="ti ti-activity-heartbeat" style={{ fontSize: 24, color: "var(--accent)" }} />
            <div style={{ flex: 1 }}>
              <div style={{ fontSize: 15, fontWeight: 600, color: "var(--accent-text)" }}>Здоровье бота</div>
              <div style={{ fontSize: 12.5, color: "var(--text-2)" }}>Прогнать проверку и увидеть, что упало, — списком, а не простынёй JSON</div>
            </div>
            <i className="ti ti-arrow-right" style={{ color: "var(--accent)", fontSize: 18 }} />
          </Link>
          <Link href="/admin/architecture" className="card" style={{ display: "flex", alignItems: "center", gap: 12, background: "var(--accent-bg)", border: "1px solid var(--accent)" }}>
          ...
          <Link href="/admin/questions" className="card" style={{ display: "flex", alignItems: "center", gap: 12, background: "var(--accent-bg)", border: "1px solid var(--accent)" }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ fontSize: 15, fontWeight: 600, color: "var(--accent-text)" }}>Вопросы бота</div>
              <div style={{ fontSize: 12.5, color: "var(--text-2)" }}>Отклик на вечерние вопросы и предложения агента-редактора — одобрить одним тапом</div>
            </div>
            <i className="ti ti-arrow-right" style={{ color: "var(--accent)", fontSize: 18 }} />
          </Link>
          ...
          <Link href="/admin/channels" className="card" style={{ display: "flex", alignItems: "center", gap: 12, background: "var(--accent-bg)", border: "1px solid var(--accent)" }}>
            <i className="ti ti-route" style={{ fontSize: 24, color: "var(--accent)" }} />
            <div style={{ flex: 1 }}>
              <div style={{ fontSize: 15, fontWeight: 600, color: "var(--accent-text)" }}>Каналы привлечения</div>
              <div style={{ fontSize: 12.5, color: "var(--text-2)" }}>Помеченные ссылки для посевов и видео — какой канал приводит людей, которые остаются</div>
            </div>
            <i className="ti ti-arrow-right" style={{ color: "var(--accent)", fontSize: 18 }} />
          </Link>
